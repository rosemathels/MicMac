<!-- Ce script correspond à la page html pour la création d'un chantier -->
<?php
  session_start();
?>
<!DOCTYPE html>
      ...
      <div class="container">
        <h2>Créer chantier</h2>
          <form class="form-horizontal" method= "post" action="UploadPictures.php" enctype="multipart/form-data">
            ...
            <div class="form-group">
              <div class="col-sm-10">
                <input type="checkbox" name="garder_calcul" value="yes"> Je souhaite récupérer le dossier MicMac complet <br>
              </div>
            </div>
          <div class="form-group">
